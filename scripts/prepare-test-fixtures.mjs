...
const sources = [
  ...
  "src/core/windowing/surfaceActivityCore.ts",
  ...
  "src/plugins/caffeine/caffeinePresentation.ts",
  ...
  "src/plugins/quickLauncher/quickLauncherScheduling.ts",
  "src/plugins/screenshot/capture/captureCanvas.ts",
  "src/plugins/screenshot/capture/captureExport.ts",
  "src/plugins/screenshot/capture/captureGeometryModel.ts",
  ...
  "src/plugins/screenshot/capture/captureTargetModel.ts",
